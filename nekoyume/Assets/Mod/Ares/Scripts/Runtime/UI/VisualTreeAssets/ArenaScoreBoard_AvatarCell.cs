...
namespace NineChronicles.Mod.Ares.UI.VisualTreeAssets
{
    public class ArenaScoreBoard_AvatarCell
    {
            ...
            int index)
        {
            ...
            _index = index;
            _root = root;
            _portrait = _root.Q<VisualElement>("arena-score-board__avatar-cell__portrait");
            _label0 = _root.Q<Label>("arena-score-board__avatar-cell__label-0");
            _label1 = _root.Q<Label>("arena-score-board__avatar-cell__label-1");
            _label2 = _root.Q<Label>("arena-score-board__avatar-cell__label-2");
            _calculateButton = _root.Q<Button>("arena-score-board__avatar-cell__calculate_button");
            _calculateButton.RegisterCallback<ClickEvent>(OnClickCalculate);
            _choiceButton = _root.Q<Button>("arena-score-board__avatar-cell__choice_button");
